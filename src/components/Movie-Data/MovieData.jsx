...
export default function MovieData({ data, opened, closeMovieData }) {
  return (
    <div className={`Movie-data ${opened ? 'opened' : 'closed'} text-white w-full h-[710px]`}>
      <div style={{ backgroundImage: `url(https://image.tmdb.org/t/p/w500/${data.backdrop_path})` }} className="movie__backdrop_path w-full h-full bg-cover relative">
